...
router.post('/check-in', isAuthenticated,  MoodCheckInController);
router.get('/today/status', isAuthenticated, IsUserAlreadyCheckedInTodayController);
router.get('/weekly/status',isAuthenticated, GetWeeklyUserMoodStats);
router.get('/weekly/mood/chart',isAuthenticated,  GetWeeklyMoodChartController);
router.get('/weekly/sentiment/status',isAuthenticated, GetWeeklySentimentController);
router.get('/emotions/today', isAuthenticated, GetTodayEmotionsController);
